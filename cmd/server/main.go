...
import (
	...
	_ "github.com/lib/pq"
	"github.com/ramesharun/hawkeye-management-svc/internal/auth"
	"github.com/ramesharun/hawkeye-management-svc/internal/config"
	"github.com/ramesharun/hawkeye-management-svc/internal/errors"
	"github.com/ramesharun/hawkeye-management-svc/internal/healthcheck"
	"github.com/ramesharun/hawkeye-management-svc/internal/monitor"
...
func buildHandler(logger log.Logger, db *dbcontext.DB, cfg *config.Config) http.Handler {
	...
	monitor.RegisterHandlers(rg.Group(""),
		monitor.NewService(monitor.NewRepository(db, logger), logger),
		authHandler, logger,
	)
